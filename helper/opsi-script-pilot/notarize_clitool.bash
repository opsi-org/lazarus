...
APP_SPECIFIC_PASSWORD=ellk-nvja-xmhq-lmhc

BUNDLE_ID=org.opsi.opsi-script-pilot
EXECUTABLE_NAME=opsi-script-pilot
...
echo "Code signing..."
codesign -vvv --force --strict --options=runtime --timestamp -s "$CODE_SIGN_SIGNATURE" $FULLPATHTOEXE
