unit opsi_configed_installer_unit_distr;
...
begin
  ...
  Distribution.Left := ConfigedInstaller.Left + Round(ConfigedInstaller.Width / 2) -
    Round(Width / 2);
  Distribution.Top := ConfigedInstaller.Top + Round(ConfigedInstaller.Height / 2) -
    Round(Height / 2);
