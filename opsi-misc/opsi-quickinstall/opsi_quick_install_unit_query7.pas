...
begin
  ...
  else if Query5_dhcp.RadioBtnGateway172.Checked = True then
  ...
  if Query5_dhcp.RadioBtnNameserver10.Checked = True then
    FileText.Add(propertyName + '=10.100.1.2')
  else if Query5_dhcp.RadioBtnNameserver172.Checked = True then
    FileText.Add(propertyName + '=172.16.166.1')
  ...
  else if Query5_dhcp.RadioBtnAddress172.Checked = True then
  ...
  if Query.RadioBtnOpsi41.Checked = True then
