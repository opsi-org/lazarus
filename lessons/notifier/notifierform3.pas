...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure ButtonTransparent4Click(Sender: TObject);
...
procedure TForm1.ButtonTransparent4Click(Sender: TObject);
begin
  //MakeTransparent;
end;
...
(*
// http://stackoverflow.com/questions/10098374/how-to-make-form-transparent-while-keeping-the-component-visible
procedure MakeTransparent;
var
  AControl: TControl;
  A, Margin, X, Y, CtlX, CtlY: integer;
begin
  Margin := (form2.Width - ClientWidth) div 2;
