    ...
    begin
      ...
      if fUTF8valid = false then
        ...
        if encoded = true then
          begin
            Item.UTF8ArchiveFileName:=s;
            Item.UTF8DiskFileName:=s;
          end;
        end;
      //*******************************************************************
...
begin
  ...
  // FCodepage := 'cp850';  // DOS western europe latin-1 (french)
  // FCodepage := 'cp852';  // DOS central europe
  // FCodepage := 'cp866';  // DOS and Windows console's cyrillic

  // FCodepage := 'iso88591';  // central europe
  // FCodepage := 'iso88592';  // eastern europe
  // FCodepage := 'iso885915'; // western european languages

  // FCodepage := 'cp1250'; // central europe
  // FCodepage := 'cp1251'; // cyrillic
  // FCodepage := 'cp1252'; // latin 1
  // FCodepage := 'cp1253'; // greek
  // FCodepage := 'cp1254'; // turkish
  // FCodepage := 'cp1255'; // hebrew
  // FCodepage := 'cp1256'; // arabic
  // FCodepage := 'cp1257'; // baltic
  // FCodepage := 'cp1258'; // vietnam

  // FCodepage := 'cp874';  // thai
  // FCodepage := 'cp932';  // japanese
  // FCodepage := 'cp936';  // chinese
  // FCodepage := 'cp949';  // korea
  // FCodepage := 'cp950';  // chinese complex

  // FCodepage := 'macintosh'; // Macintosh, alias Mac OS Roman
  // FCodepage := 'koi8';      // russian cyrillic
  //**********************************************************************
  //*******************************************************************
