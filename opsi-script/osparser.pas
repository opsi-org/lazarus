    ...
    begin
      ...
      begin //Element gefunden
        ...
        begin
          ...
          s3:=s3+' '+namespace+'>'; //und wieder anfaegen
    ...
    try
      ...
      begin
        ...
        begin //Element gefunden
          ...
          if s3[p2-1]=' ' then //wir haben bei Add ein Leerzeichen hinzugefuegt
...
begin
 ...
 (* XMLAddNamespace(Datei:string,ElementName:string,Namespace:string):Boolean
  True, wenn Namespace noch nicht da war und eingefuegt werden muesste *)
