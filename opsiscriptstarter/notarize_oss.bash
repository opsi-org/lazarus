...
APP_SPECIFIC_PASSWORD=btgc-bvrf-mllx-wmcc

BUNDLE_ID=org.opsi.opsiscriptstarter
EXECUTABLE_NAME=opsiscriptstarter
...
echo "Code signing..."
codesign -vvv --force --strict --options=runtime --entitlements opsiscriptstarter.entitlements --timestamp -s "$CODE_SIGN_SIGNATURE" $FULLPATHTOEXE
